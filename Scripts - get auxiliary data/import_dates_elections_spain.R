  ...
  tibble(cod_elec = "02", type_elec = "congress",
         date =
           as_date(c("1977-06-15", "1979-03-01", "1982-10-28",
                     ...
                     "2016-06-26", "2019-04-28", "2019-11-10", "2023-07-23",NA)))
  ...
  tibble(cod_elec = "04", type_elec = "local",
         date =
           as_date(c("1979-04-03", "1983-05-08", "1987-06-10",
                     ...
                     "2015-05-24", "2019-05-26", "2023-05-28", "2023-05-28")))
  ...
  tibble(cod_elec = "07", type_elec = "EU",
         date =
           as_date(c("1987-06-10", "1989-06-15",
                     ...
                     "2014-05-25", "2019-05-26", "2024-06-26")))
...
# ----- write_csv -----
write_csv(dates_elections_spain, "./Auxiliary data/dates_elections_spain.csv")
